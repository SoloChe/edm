...
dataset_name=brats21-simplex-t
...
torchrun --nproc_per_node=2\
         ...
         train.py --outdir=training-runs --data=$data_dir --cond=0 --arch=ddpmpp --batch-gpu=32 --tick=10 --dump=10 --snap=10 --workers=4 --batch=128 --cache=False --augment=0 --arch=ddpmpp --precond=vp --lr=2e-4 --ema=0.9 --dropout=0.10 --grad=False --dataset_name=$dataset_name --gaussian=False
